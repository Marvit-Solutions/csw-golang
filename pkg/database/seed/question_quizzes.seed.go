...
func CreateQuestionQuizzes() []*ds.QuestionQuizzes {
	questionQuizzes := []*ds.QuestionQuizzes{
		...
		{
			ID:             "f4fad3b8-e6f0-48b3-8dd9-ba6982b90634",
			CreatedAt:      time.Now(),
			UpdatedAt:      time.Now(),
			TestTypeQuizID: "f8259b82-41ca-4d58-90e7-c2be3f4c235f",
			Image:          "assets/img/questions/question.png",
		...
		{
			ID:             "3fdcf4ac-e8ba-4bc8-bbdf-906fc756ebc2",
			CreatedAt:      time.Now(),
			UpdatedAt:      time.Now(),
			TestTypeQuizID: "f8259b82-41ca-4d58-90e7-c2be3f4c235f",
			Image:          "assets/img/questions/question.png",
		...
		{
			ID:             "b8456d7e-6940-485b-b32c-16207d8e1531",
			CreatedAt:      time.Now(),
			UpdatedAt:      time.Now(),
			TestTypeQuizID: "f8259b82-41ca-4d58-90e7-c2be3f4c235f",
			Image:          "assets/img/questions/question.png",
		...
		{
			ID:             "fe2d281e-fc4e-427e-b487-63d4065ef7a3",
			CreatedAt:      time.Now(),
			UpdatedAt:      time.Now(),
			TestTypeQuizID: "f8259b82-41ca-4d58-90e7-c2be3f4c235f",
			Image:          "assets/img/questions/question.png",
