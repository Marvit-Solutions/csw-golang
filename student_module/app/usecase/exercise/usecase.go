...
type usecase struct {
	...
	exerciseSubmissionsModuleRepo    repository.ExerciseSubmissionsModuleRepository
	exerciseSubmissionsSubModuleRepo repository.ExerciseSubmissionsSubModuleRepository
...
func NewUsecase(
	...
	return &usecase{
		...
		exerciseSubmissionsModuleRepo:    service.NewExerciseSubmissionsModuleService(db, nil),
		exerciseSubmissionsSubModuleRepo: service.NewExerciseSubmissionsSubModuleService(db, nil),
