ALTER TABLE
        IF EXISTS public.addresses DROP CONSTRAINT IF EXISTS user_detail_address_fk;
...
ALTER TABLE
        IF EXISTS public.exercise_answers DROP CONSTRAINT IF EXISTS submission_exercise_answer_fk;
...
ALTER TABLE
        IF EXISTS public.exercise_scores DROP CONSTRAINT IF EXISTS submission_exercise_score_fk;
...
ALTER TABLE
        IF EXISTS public.quiz_scores DROP CONSTRAINT IF EXISTS submission_quiz_score_fk;
...
ALTER TABLE
        IF EXISTS public.user_testimonials DROP CONSTRAINT IF EXISTS testimonial_user_testimonial_fk;
